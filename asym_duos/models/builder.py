...
def get_model_and_tokenizer(
    ...
    """Load an HF causal LM + tokenizer, optionally wrapping with a PEFT adapter.

    If ``peft_path`` is set, an existing adapter is loaded; otherwise a fresh
    PEFT module is attached when ``use_peft`` is true.
    """
